...
def get_main_keyboard():
    buttons = [
        ...
        [KeyboardButton(text="🆘 ЗАПРОС ПОДДЕРЖКИ (нужна помощь)")],  # Изменено!
        [KeyboardButton(text="🏛️ Меры поддержки государства")],
        [KeyboardButton(text="🧠 Поддержка психолога")],  # Изменено!
...
def get_help_categories():
    buttons = [
        ...
        [KeyboardButton(text="🧠 Поддержка психолога")],  # Изменено!
        [KeyboardButton(text="🆘 Другая поддержка")],  # Новая кнопка!
...
def get_request_categories():
    buttons = [
        ...
        [KeyboardButton(text="📝 Другая поддержка")],  # Изменено!
        [KeyboardButton(text="← Назад в главное меню")]
    ]
